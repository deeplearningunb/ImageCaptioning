...
Para criação de issue, um [template de issue](https://github.com/deeplearningunb/ImageCaptioning/issues/new/choose) deve ser seguido.

Caso encontre um bug ou tenha alguma sugestão de melhoria ao projeto, siga os passos abaixo:

1. Verifique se já existe a [issue no repositório](https://github.com/deeplearningunb/ImageCaptioning/issues);
2. Caso não exista nenhuma issue relacionada, [crie uma issue](https://github.com/deeplearningunb/ImageCaptioning/issues/new/choose);
...
Durante a criação de um _pull request_, deve-se observar o [template definido no repositório](https://github.com/deeplearningunb/ImageCaptioning/compare).
